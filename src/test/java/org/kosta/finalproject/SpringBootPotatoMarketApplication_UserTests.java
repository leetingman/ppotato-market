...
class SpringBootPotatoMarketApplication_UserTests {
	...
	// 회원가입
	 @Test
	 void registerUser() {
	 userMapper.registerUser(new UserVO("spring2", "1234", "01012341234", "미국",
	 "a@naver.com"));
...
//	
//	 @Test 
//	 void registerUser() { userMapper.registerUser(new
...
//	 }
	 ...
	 @Test //생성자 오버로딩 규칙위배때문에 address를 제외한 이미지,sysdate를 넣어주었고 mapper.xml에는
	 //address만 변경되도록함
