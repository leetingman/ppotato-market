...
public class ItemServiceImpl implements ItemService {
	...
	@Override
	public void uploadMultiImage(ItemVO itemVO, MultipartHttpServletRequest request, MultipartFile[] imgfile)
...
// 		String filepath=request.getServletContext().getRealPath("assets/upload/");
	...
	public List<ImageVO> findItemImageListByItemId(int itemId) {
		// TODO Auto-generated method stub
		List<ImageVO> list = itemMapper.findItemImageListByItemId(itemId);
...
//		System.out.println(imageVO);
	...
	public void delCheckedImg(List<Integer> list) {
		// TODO Auto-generated method stub
		for (int i = 0; i < list.size(); i++)
			itemMapper.deleteImage(list.get(i));
