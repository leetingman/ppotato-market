			...
			<section class="block">
				<div class="container">
					<div class="row">
						...
						<p id="article-counts">date ${itemDetail.itemCreatedAt }  ∙check 6 
								∙chat ${crnum} ∙hits  ${itemDetail.itemHit}</p> 
							<c:choose>
							...
							<form action="updateForm">
								<input type="hidden" name="itemId" value="${itemDetail.itemId}">
								<button type="submit" class="btn btn-primary width-100">Edit</button>
							</form>
							<br />
							<!-- 삭제하기 -->
							<form action="deleteItem" method="post">
								<sec:csrfInput />
								<input type="hidden" name="itemId" value="${itemDetail.itemId}">
								<button type="submit" class="btn btn-primary width-100">Delete</button>
							</form>
							</c:otherwise>
							</c:choose>
							<!--end Description-->
											...
											<div class="wrapper">
												<div class="image">
													...
													<a
														...
														src="assets/upload/${sellerItemImageList[status.index].imageName}"
														alt="">
													</a>
												</div>
												<!--end image-->
												...
												<div class="price">${userItemList.itemPrice}$</div>
												<div class="meta">
													<figure>
													<div>hits ${userItemList.itemHit}</div>
													</figure>
												</div>
												<!--end meta-->
											</div>
