                                ...
                                <div class="item">
                                    ...
                                    <div class="wrapper">
                                       ...
                                       <h4>
                                        ...
                                        <!--end admin-controls-->
                                        <a href="single-listing-1.html" class="detail text-caps underline" style="right: 35rem;">예약중으로 변경</a>
                                        <a href="single-listing-1.html" class="detail text-caps underline" style="right: 25rem;">거래완료로 변경</a>
                                    </div>
                                </div>
                                <!--end item-->
                            </div>
