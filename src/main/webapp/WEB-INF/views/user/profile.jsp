										...
										<!-- Author -->
											...
											<div class="space-between">
													...
													<ul id="profile-detail">
														<li class="profile-detail-title"><span class="fa fa-heart-o"></span> ratings <span
															class="profile-detail-count">100%</span></li>
														<li class="profile-detail-title"><span class="fa fa-comment-o"></span> answerd questions <span
															class="profile-detail-count">100 %</span></li>
													</ul>
										...
										<!--============ End Author ======================================================================-->
											...
											<div id="user-records-detail">
												<section id="user-filter">
													<ul>
														<li><a class="active" href="/u/VlqYm7Wj8AG0B6G9">See other items</a></li>
														<li><a class=""
															href="#">Seller feedback</a></li>
