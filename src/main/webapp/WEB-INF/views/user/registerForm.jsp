			...
			<div class="row justify-content-center">
              ...
              <%-- csrf 토큰 --%>
							...
							<div class="form-group">
								<input name="userId" type="text" placeholder="Please enter your ID"
							...
							<div class="form-group">
								<input name="userPassword" id="login_password" type="password"
									placeholder="Please enter your password" class="form-control check" required
							...
							<!-- 이메일 -->
							<div class="form-group">
								<input type="text" id="email_id" name="userEmail" class="form-control" value="" placeholder="email" maxlength="18">
								@ <input type="text" id="email_domain" name="email_domain" class="form-control" value="" placeholder="Email@ex.com" maxlength="18"> 
							</div>
							...
							<div class="form-group">
								<input name="userTel" type="text"
									placeholder="Phone" class="form-control check"
							...
							<div class="form-group">
								...
								<button type="button" id="getMyPositionBtn"
									style="display: none;">turn on your location</button>
								<button type="button" id="stopMovingBtn" style="display: none;">turn off drag</button>
							</div>
							<!--end form-group-->
							<div class="form-group">
								<button type="submit" class="btn btn-primary2 width-100"
									style="font-size: 1.3rem;">Create Account</button>
							</div>
						</form>
					</div>
					<hr>
					...
					<div style="text-align: center; font-size: 1.3rem;">
						<a href="/login_form">I have a account!</a>
					</div>
				</div>
				<!--end col-md-6-->
			</div>
