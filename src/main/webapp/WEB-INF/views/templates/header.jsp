                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item active">
                                     ...
                                     <li class="nav-item">
                                        <a class="nav-link" href="communityBoard">near by</a>
                                    </li>
                                     <li class="nav-item">
                                        <a class="nav-link" href="headerChatForm?userId=${headeruserId}" >chat</a>
                                    </li>
                                     <li class="nav-item">
                                        <a href="faqBoard" class="nav-link">FAQ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="writeForm" class="btn btn-primary text-caps btn-rounded btn-framed">Sell</a>
                                    </li>
                                </ul>
                                <!--Main navigation list-->
                            </div>
