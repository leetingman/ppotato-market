...
<body>
	<div id="myNav" class="overlay">
		...
		<div class="overlay-content">
			<a href="userManagement">Admin</a> <a href="categoryManagement">categoty</a>
		...
		<div class="hero-wrapper" style="padding-bottom: 0rem;">
			...
			<div class="secondary-navigation">
				...
				<ul class="left"><li><a href="main"> <i class="fa fa-home"></i>Home
					...
					<ul class="right">
						<li><a id="managingBtn" href="#"> <i class="fa fa-wrench"></i>Manage
						</a></li>
	...
	<div style="margin-left: 10px; margin-top: 10px;">
		<a href="adminMain" style="text-decoration: underline double;">back</a>
	</div>
					...
					<div class="col-md-12">
						...
						<div id="column1">
								<div class="col-md-4" style="display:block;">
									<label for="find" class="col-form-label">find userId</label>
									<input name="userId" type="text" id="findUser" placeholder="user">
								</div>
							<section>
								...
								<table style="margin-top:30px;">
									<thead>
										<tr>
											<th>ID</th>
											<th style="80px;text-align:center;">Add</th>
										</tr>
									</thead>
									<tbody id="userInfo">
										<!-- 검색결과 ajax 반응 -->
						...
						<div id="column2">
							<label for="admin" class="col-form-label">Admin Account</label>
							<section>
								<table >
									<thead>
										<tr>
	      	...
	      	$.ajax({
					...
					success:function(result){
						...
						if(!result){
							let userInfo="";
							userInfo+="<tr>";
							userInfo="<td colspan='2'>No exact matches found</td>"
							userInfo+="</tr>";
		 						...
		 						if(!confirm("confirm?")){
									return false;
		 							...
		 							$.ajax({
										...
										success:function(result){
											alert("Administrator registration completed.");
