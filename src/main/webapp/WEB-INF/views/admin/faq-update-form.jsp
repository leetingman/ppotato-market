...
<body>
	<div id="myNav" class="overlay">
		...
		<div class="overlay-content">
			<a href="adminManagement">Admin</a> <a href="categoryManagement">category</a>
	...
	<a href="faqManagement" style="text-decoration:underline double;">Back</a>
	</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<form class="form form-submit" method="post" action="updateFAQ">
							<sec:csrfInput />
