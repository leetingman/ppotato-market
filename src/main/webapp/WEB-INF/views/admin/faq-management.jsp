...
<body>
	<div id="myNav" class="overlay">
		...
		<div class="overlay-content">
			<a href="userManagement">Admin</a> <a href="categoryManagement">category</a>
		...
		<section class="block">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<section>
							<h3>FAQ Manage (${TotalFAQCount })</h3>
							<a href="faq-write-form" style="float: right;">Create Post</a>
							<!--end form-group-->
						</section>
						<section>
							<table>
								<tr>
									...
									<th style="width:250px;"><a href="#">Title</a></th>
									<th >Content</th>
